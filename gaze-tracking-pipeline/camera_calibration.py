...
#             img_name = f"capture_{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}_{img_counter}.png"
...
def calibration(image_path, every_nth: int = 1, debug: bool = False, chessboard_grid_size=(9, 6)):
    ...
    image_path = 'C:\\Users\\uos\\Desktop\\EyeTracking\\gaze-tracking-pipeline\\callibration_img'
...
if __name__ == '__main__':
    # 1. record video
    # record_video(width=640, height=480, fps=30)
